...
class WaitList(db.Model):
    ...
    ApprovedToJoin = db.Column(db.DateTime)
    Notified = db.Column(db.DateTime)
    ...
    ApplicantAccepts = db.Column(db.DateTime)
    ApplicantDeclines = db.Column(db.DateTime)
    NoLongerInterested = db.Column(db.DateTime)
